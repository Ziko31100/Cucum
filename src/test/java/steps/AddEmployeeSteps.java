...
/*
    @Then("Verify the informantion")
    public void verifyTheInformantion() {
        String query="select emp_firstname,emp_middle_name,emp_lastname from hs_hr_employees where employee_id=85108330";
